...
function LayotLoginRegister({ children, title }: LayoutProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex gap-12 absolute justify-end w-1/3 z-10">
        <div
          className="w-64 h-64 rounded-full p-5 bg-slate-400 flex justify-center items-center transition-all duration-700"
          style={{ backgroundColor: changeColors.bgIcon, opacity: "0.25" }}
        >
          <div
            className=" rounded-full w-36 h-36  transition-all duration-700"
            style={{ backgroundColor: changeColors.parentBg }}
          ></div>
        </div>
        <div
      ...
      {/* Start form */}
      <div className=" absolute w-1/3 h-2/3 px-4 py-2  z-20 ">
        {/* Title */}
        <div className="mb-16">
